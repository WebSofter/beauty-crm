...
-- Дамп данных таблицы django_db.appointment_appointment: ~1 rows (приблизительно)
...
INSERT INTO `auth_user` (`id`, `password`, `last_login`, `is_superuser`, `username`, `first_name`, `last_name`, `email`, `is_staff`, `is_active`, `date_joined`) VALUES
	...
	(12, 'pbkdf2_sha256$1000000$YLVx1lehaR8Of10KQJZYGC$dYQS+sUvT1/q4Sik4ornB2hpm2iidj1xY7I4fIXMld4=', '2025-05-20 09:10:47.631347', 0, 'newuser99', 'New99', 'User99', 'newuser@mail.ru', 0, 1, '2025-05-18 17:49:45.984048');
...
-- Дамп данных таблицы django_db.django_migrations: ~43 rows (приблизительно)
...
-- Дамп данных таблицы django_db.profile_clientprofile: ~0 rows (приблизительно)
...
-- Дамп данных таблицы django_db.profile_workerprofile: ~1 rows (приблизительно)
...
-- Дамп данных таблицы django_db.profile_workerprofile_position: ~3 rows (приблизительно)
...
-- Дамп данных таблицы django_db.team_plan: ~1 rows (приблизительно)
...
-- Дамп данных таблицы django_db.team_team: ~1 rows (приблизительно)
